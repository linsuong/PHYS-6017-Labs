...
\begin{figure}
    \centering
    \includegraphics{Projects/ForcedSimplePendulum/Plots/Phase plot of F~mg as damping coefficient k increases from 50 to 10.png}
...
\section{Appendix C: Plots for the R-L pendulum}